...
const meta: Meta<typeof SectionHeader> = {
  title: 'Product Components/Page Headers/Section Header',
...
export const Gallery: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <SectionHeader />
      <SectionHeader leading={<Avatar persona="Sophia Williams" size={48} type="Illustration" />} />
      <SectionHeader leading={<KeyIcon icon="user-6-line" size="lg" color="gray" style="stroke" />} />
      <SectionHeader leading={<PlaceholderBrand company="Aurora" size={48} />} />
      <SectionHeader leading={<PlaceholderBrand company="Synergy" size={48} />} />
    </div>
  ),
};
